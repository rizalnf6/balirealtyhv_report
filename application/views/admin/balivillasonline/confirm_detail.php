...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-5">  
      ...
      <!-- Button Edit -->
      <?php if ($default['status_enquiry'] == "Confirm" AND $default['balivillasonline_status'] == "1" AND($this->session->userdata('level')=="admin" OR $this->session->userdata('level')=="reservation")): ?>
        <a href="<?php echo $button_edit_confirm."/".$default['report_id']; ?>">
          <button type="button" class="btn btn-filter btn-xs">Edit</button>
        </a>
      <?php endif ?>

      <?php if ($default['status_enquiry'] == "Proposed" AND $default['balivillasonline_status'] == "1" AND($this->session->userdata('level')=="admin" OR $this->session->userdata('level')=="reservation")): ?>
        <a href="<?php echo $button_edit_propose."/".$default['report_id']; ?>">
          <button type="button" class="btn btn-filter btn-xs">Edit</button>
        </a>
      <?php endif ?>

      <?php if ($default['status_enquiry'] == "Extend Stay" AND $default['balivillasonline_status'] == "1" AND($this->session->userdata('level')=="admin" OR $this->session->userdata('level')=="reservation")): ?>
        <a href="<?php echo $button_edit_extend."/".$default['report_id']; ?>">
          <button type="button" class="btn btn-filter btn-xs">Edit</button>
        </a> 
      <?php endif ?>
      <?php if ($default['balivillasonline_status'] == "1" AND($this->session->userdata('level')=="admin" OR $this->session->userdata('level')=="reservation")): ?>
  ...
  <div class="row">
    ...
    <div class="col-sm-10">
      <h3 class="form-heading-details-ahr">Guest Details</h3>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <h4 class="guest_detail"><b class="label-detail">Guest Name : </b> 
            ...
            <?php 
              if ($default['balivillasonline_status'] != "1") {
      ...
      <hr /> <h3 class="form-heading-details-ahr">Payment Details</h3>
      ...
      <hr /> <h3 class="form-heading-details-ahr">Arrival Details</h3>
      ...
      <hr /> <h3 class="form-heading-details-ahr">Other Details</h3>
      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <h4 class="guest_detail"><b class="label-detail">Last Modified By : </b> <?php if(isset($default['balivillasonline_modified_by'])) {echo $default['balivillasonline_modified_by'];} ?></h4>
        </div>
         <div class="col-sm-12">
          <h4 class="guest_detail"><b class="label-detail">Last Modified By Time : </b> 
            <?php 
              if($default['balivillasonline_last_modified'] == "0000-00-00"){ 
                echo "<i style=color:#d9534f>TBA</i>"; 
              } else { $last_modified = Date("j F Y (H:i)", strtotime($default['balivillasonline_last_modified'])); 
                echo $last_modified;
              } 
            ?>
          </h4>
