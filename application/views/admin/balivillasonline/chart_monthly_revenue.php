...
var data = {
  ...
  datasets: [{
      ...
      data: [<?php
                $i = 1;
          while($i <= 12) {
              $chartRevenue = $this->db->query("SELECT SUM(revenue_nett) AS revenue FROM balivillasonline 
      ...
      <tbody>
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 12) {
              $tableRevenue = $this->db->query("SELECT SUM(revenue_nett) AS revenue FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE MONTH(balivillasonline.confirm_date)=$i 
                AND YEAR(balivillasonline.confirm_date)='2017' 
            ...
            $i = 1;
              while($i <= 12) {
                $maxTableRevenue = $this->db->query("SELECT SUM(revenue_nett) AS revenue FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE MONTH(balivillasonline.confirm_date)=$i 
                AND YEAR(balivillasonline.confirm_date)='2017' 
            ...
            <?php
              $totalTableRevenue = $this->db->query("SELECT SUM(revenue_nett) AS totalrevenue FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
