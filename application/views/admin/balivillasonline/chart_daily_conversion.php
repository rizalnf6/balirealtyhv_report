...
var data = {
  ...
  datasets: [{
      ...
      data: [<?php
          ...
          while($i <= 31)
          {
              $chart_daily_enquiry_conversion2017 = $this->db->query("SELECT * FROM balivillasonline 
              ...
              $chart_daily_booking_conversion2017 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
      ...
      data: [<?php
          ...
          while($i <= 31)
          {
              $chart_daily_enquiry_conversion2018 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.enquiry_date)=$i 
                AND MONTH(balivillasonline.enquiry_date)=$month 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillasonline.balivillasonline_status='1'");
              $chart_daily_booking_conversion2018 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.confirm_date)=$i 
                AND MONTH(balivillasonline.confirm_date)=$month 
      ...
      data: [<?php
          ...
          while($i <= 31)
          {
              $chart_daily_enquiry_conversion2019 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.enquiry_date)=$i 
                AND MONTH(balivillasonline.enquiry_date)=$month 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillasonline.balivillasonline_status='1'");
              $chart_daily_booking_conversion2019 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.confirm_date)=$i 
                AND MONTH(balivillasonline.confirm_date)=$month 
      ...
      data: [<?php
          ...
          while($i <= 31)
          {
              $chart_daily_enquiry_conversion2020 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.enquiry_date)=$i 
                AND MONTH(balivillasonline.enquiry_date)=$month 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillasonline.balivillasonline_status='1'");
              $chart_daily_booking_conversion2020 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.confirm_date)=$i 
                AND MONTH(balivillasonline.confirm_date)=$month 
      ...
      data: [<?php
          ...
          while($i <= 31)
          {
              $chart_daily_enquiry_conversion2021 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.enquiry_date)=$i 
                AND MONTH(balivillasonline.enquiry_date)=$month 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillasonline.balivillasonline_status='1'");
              $chart_daily_booking_conversion2021 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.confirm_date)=$i 
                AND MONTH(balivillasonline.confirm_date)=$month 
      ...
      data: [<?php
          ...
          while($i <= 31)
          {
              $chart_daily_enquiry_conversion2022 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.enquiry_date)=$i 
                AND MONTH(balivillasonline.enquiry_date)=$month 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillasonline.balivillasonline_status='1'");
              $chart_daily_booking_conversion2022 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.confirm_date)=$i 
                AND MONTH(balivillasonline.confirm_date)=$month 
      ...
      <tbody>
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 31) {
              $table_daily_enquiry_conversion2017 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.enquiry_date)=$i 
                AND MONTH(balivillasonline.enquiry_date)=$month 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillasonline.balivillasonline_status='1'");
              $table_daily_booking_conversion2017 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.confirm_date)=$i 
                AND MONTH(balivillasonline.confirm_date)=$month 
            ...
            $i = 1;
            while($i <= 31) {
              $max_table_daily_enquiry_conversion2017 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.enquiry_date)=$i 
                AND MONTH(balivillasonline.enquiry_date)=$month 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillasonline.balivillasonline_status='1'");
              $max_table_daily_booking_conversion2017 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.confirm_date)=$i 
                AND MONTH(balivillasonline.confirm_date)=$month 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 31) {
              $table_daily_enquiry_conversion2018 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.enquiry_date)=$i 
                AND MONTH(balivillasonline.enquiry_date)=$month 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillasonline.balivillasonline_status='1'");
              $table_daily_booking_conversion2018 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.confirm_date)=$i 
                AND MONTH(balivillasonline.confirm_date)=$month 
            ...
            $i = 1;
            while($i <= 31) {
              $max_table_daily_enquiry_conversion2018 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.enquiry_date)=$i 
                AND MONTH(balivillasonline.enquiry_date)=$month 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillasonline.balivillasonline_status='1'");
              $max_table_daily_booking_conversion2018 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.confirm_date)=$i 
                AND MONTH(balivillasonline.confirm_date)=$month 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 31) {
              $table_daily_enquiry_conversion2019 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.enquiry_date)=$i 
                AND MONTH(balivillasonline.enquiry_date)=$month 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillasonline.balivillasonline_status='1'");
              $table_daily_booking_conversion2019 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.confirm_date)=$i 
                AND MONTH(balivillasonline.confirm_date)=$month 
            ...
            $i = 1;
            while($i <= 31) {
              $max_table_daily_enquiry_conversion2019 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.enquiry_date)=$i 
                AND MONTH(balivillasonline.enquiry_date)=$month 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillasonline.balivillasonline_status='1'");
              $max_table_daily_booking_conversion2019 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.confirm_date)=$i 
                AND MONTH(balivillasonline.confirm_date)=$month 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 31) {
              $table_daily_enquiry_conversion2020 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.enquiry_date)=$i 
                AND MONTH(balivillasonline.enquiry_date)=$month 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillasonline.balivillasonline_status='1'");
              $table_daily_booking_conversion2020 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.confirm_date)=$i 
                AND MONTH(balivillasonline.confirm_date)=$month 
            ...
            $i = 1;
            while($i <= 31) {
              $max_table_daily_enquiry_conversion2020 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.enquiry_date)=$i 
                AND MONTH(balivillasonline.enquiry_date)=$month 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillasonline.balivillasonline_status='1'");
              $max_table_daily_booking_conversion2020 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.confirm_date)=$i 
                AND MONTH(balivillasonline.confirm_date)=$month 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 31) {
              $table_daily_enquiry_conversion2021 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.enquiry_date)=$i 
                AND MONTH(balivillasonline.enquiry_date)=$month 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillasonline.balivillasonline_status='1'");
              $table_daily_booking_conversion2021 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.confirm_date)=$i 
                AND MONTH(balivillasonline.confirm_date)=$month 
            ...
            $i = 1;
            while($i <= 31) {
              $max_table_daily_enquiry_conversion2021 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.enquiry_date)=$i 
                AND MONTH(balivillasonline.enquiry_date)=$month 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillasonline.balivillasonline_status='1'");
              $max_table_daily_booking_conversion2021 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.confirm_date)=$i 
                AND MONTH(balivillasonline.confirm_date)=$month 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 31) {
              $table_daily_enquiry_conversion2022 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.enquiry_date)=$i 
                AND MONTH(balivillasonline.enquiry_date)=$month 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillasonline.balivillasonline_status='1'");
              $table_daily_booking_conversion2022 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.confirm_date)=$i 
                AND MONTH(balivillasonline.confirm_date)=$month 
            ...
            $i = 1;
            while($i <= 31) {
              $max_table_daily_enquiry_conversion2022 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.enquiry_date)=$i 
                AND MONTH(balivillasonline.enquiry_date)=$month 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillasonline.balivillasonline_status='1'");
              $max_table_daily_booking_conversion2022 = $this->db->query("SELECT * FROM balivillasonline 
                LEFT JOIN user ON user.user_id=balivillasonline.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillasonline.status_enquiry_id 
                WHERE DAY(balivillasonline.confirm_date)=$i 
                AND MONTH(balivillasonline.confirm_date)=$month 
