	...
	$(document).ready( function () {
	    $('#reminderRevenue').DataTable({
			...
			<div class="table-responsive table-scroll">          
			  	<table class="table table-striped table-ahr" id="reminderRevenue">
						...
						foreach($list_reminder_revenue as $row){
							...
							<tr>
								...
								<?php if ($row->revenue_nett == "0"): ?> 
									<td style='background-color: grey; color: white;'>$ <?php echo number_format($row->revenue_nett);?></td>
								<?php endif ?>
								<?php if ($row->revenue_nett != "0"): ?> 
								...
								<?php if ($row->revenue_gross == "0"): ?> 
									<td style='background-color: grey; color: white;'>$ <?php echo number_format($row->revenue_gross);?></td>
								<?php endif ?>
								<?php if ($row->revenue_gross != "0"): ?> 
