...
<!-- ISI DATA AKAN MUNCUL DISINI -->
  ...
  <div class="row">
    ...
    <div class="col-sm-5">  
      ...
      <?php endif ?>
      <!-- Button Propose -->
      <?php if ($default['status_enquiry'] == "Cancel" && $default['balivillasonline_status'] == "1" AND($this->session->userdata('level')=="admin" OR $this->session->userdata('level')=="reservation")): ?>
