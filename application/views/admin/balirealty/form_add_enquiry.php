		...
		<div class="col-sm-10">
			<form method="post" class="form-horizontal" name="MyForm" onsubmit="return(validate())">
				...
				<div class="col-sm-12">
					...
					<div class="col-sm-4">
						<div class="form-group form-group-md">
							<input type="email" class="form-control input-sm" name="guest_email" value="<?php if(isset($default['guest_email'])) {echo $default['guest_email'];} ?>" required>
						</div> <!--Form Group End -->
					</div> <!--End col-sm-4 -->
				</div> <!--End col 12 -->
				...
				<div class="col-sm-12">
					...
					<div class="col-sm-4">
						<div class="form-group form-group-md">
							<input type="text" class="form-control input-sm" name="phone" value="<?php if(isset($default['phone'])) {echo $default['phone'];} ?>">
						</div> <!--Form Group End -->
					</div> <!--End col-sm-4 -->
					<div class="col-sm-2" align="center">
						<div class="form-group form-group-md">
				...
				<div class="col-sm-12">
					<br /><br />
					<h4 class="form-heading-brhv"> Status Detail </h4>
					<br />
					<div class="col-sm-2" align="center">
						<div class="form-group form-group-md">
							<label class="control-label">
