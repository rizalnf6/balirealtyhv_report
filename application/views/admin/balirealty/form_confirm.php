	...
	<div class="row">
		...
		<div class="col-sm-10">
			<form method="post" class="form-horizontal" name="MyForm" onsubmit="return(validate())">
					...
					<div class="col-sm-4">
						<div class="form-group form-group-md">
							<?php if ($this->session->userdata('level')=="admin"): ?>
								...
								value="<?php if(isset($default['enquiry_date'])){echo $default['enquiry_date'];}?>" required>
							<?php endif ?>
							<?php if ($this->session->userdata('level')=="reservation"): ?>
								<input type="date" class="form-control" name="enquiry_date" 
				...
				<div class="col-sm-12">
					...
					<div class="col-sm-4">
						<div class="form-group form-group-md">
							...
							<?php endif ?>
							<?php if ($this->session->userdata('level')=="reservation"): ?>
								<select class='form-control' name='source_id' readonly>
									<option value="<?php echo $default['source_id']; ?>"><?php echo $default['source']; ?></option>
								</select>
							<?php endif ?>
						</div> <!--Form Group End -->
					</div> <!--End col-sm-3 -->
						...
						<div class="form-group form-group-md">
							...
							<?php if ($this->session->userdata('level')=="reservation"): ?>
								<select class='form-control' name='villa_id' readonly>
									<option value="<?php echo $default['villa_id']; ?>"><?php echo $default['villa']; ?></option>
								</select>
							<?php endif ?>
						</div> <!--Form Group End -->
					</div> <!--End col-sm-3 -->
				...
				<div class="col-sm-12">
					<br /><br />
					<h4 class="form-heading-brhv"> Arrival Detail </h4>
					<br />
					<div class="col-sm-2" align="center">
						<div class="form-group form-group-md">
							<label class="control-label">
