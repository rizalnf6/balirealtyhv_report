  ...
  <div class="row">
    ...
    <div class="col-sm-5">  
      <div class="button-filter-download">
        ...
        <?php endif ?>
        <!--Button Propose-->
        <?php if ($default['status_enquiry'] == "Cancel" && $default['balirealtyhv_status'] == "1" AND($this->session->userdata('level')=="admin" OR $this->session->userdata('level')=="reservation")): ?>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <h4 class="guest_detail"><b class="label-detail">Checkout Date : </b> 
            ...
            ?>
            <?php 
              if($default['checkout'] > $default['checkout']){ 
                echo "<i style=color:#d9534f>Check the Date.</i>"; 
              } else { echo "";} 
            ?>
          </h4>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <h4 class="guest_detail"><b class="label-detail">Cancelation Reason : </b> 
            ...
            <?php if($default['status_enquiry'] == "Cancel" AND $default['cancelation'] == ""){ 
              echo "<b style=color:#d9534f>Fill the cancelation reason.</b>"; 
              } else { echo "";} 
            ?>
          </h4>
        </div>
