...
<div class="container">
	...
	<div class="table-responsive">          
	  	<table class="table table-striped table-brhv" id="source">
	    <thead>
	      <tr>
	        <th>#</th>
	        <th>Source</th>
	      ...
	      <?php
				...
				foreach($list_source as $row){
					...
					<tr>
						...
						<td><?php echo $row->source_category;?></td>
						<td><?php echo $row->status_other;?></td>
						<td>
							<div class="action-button">
								<a href="<?php echo $button_detail."/".$row->source_id;; ?>">
									<span class='glyphicon glyphicon-eye-open' aria-hidden='true'></span>
								</a> 
								<a href="<?php echo $button_edit."/".$row->source_id;; ?>">
