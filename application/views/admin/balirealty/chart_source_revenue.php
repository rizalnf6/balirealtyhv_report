...
<canvas id="sourceRevenue" width="500px"></canvas>
<script>
var canvas = document.getElementById("sourceRevenue");
      ...
      <tbody>
        <tr>
          ...
          <?php
            ...
            while($i <= 12) {
              if ($source=='Agent') {
                  $table_sources_revenue2017 = $this->db->query("SELECT SUM(revenue_nett) AS revenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                    WHERE MONTH(balirealtyhv.confirm_date)=$i 
                    AND YEAR(balirealtyhv.confirm_date)='2017' 
                ...
                $result = $table_sources_revenue2017->result();
            ...
            $i = 1;
              while($i <= 12) {
                if ($source=='Agent') {
                  $max_table_sources_revenue2017 = $this->db->query("SELECT SUM(revenue_nett) AS revenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                    WHERE MONTH(balirealtyhv.confirm_date)=$i 
                    AND YEAR(balirealtyhv.confirm_date)='2017' 
                ...
                $maxresult = $max_table_sources_revenue2017->result();
            ...
            <?php
              if ($source=='Agent') {
                  $total_sources_revenue2017 = $this->db->query("SELECT SUM(revenue_nett) AS totalrevenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                ...
                $totalrevenue = $total_sources_revenue2017->result();
        ...
        <tr>
          ...
          <?php
            ...
            while($i <= 12) {
              if ($source=='Agent') {
                  $table_sources_revenue2018 = $this->db->query("SELECT SUM(revenue_nett) AS revenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                    WHERE MONTH(balirealtyhv.confirm_date)=$i 
                    AND YEAR(balirealtyhv.confirm_date)='2018' 
                ...
                $result = $table_sources_revenue2018->result();
            ...
            $i = 1;
              while($i <= 12) {
                if ($source=='Agent') {
                  $max_table_sources_revenue2018 = $this->db->query("SELECT SUM(revenue_nett) AS revenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                    WHERE MONTH(balirealtyhv.confirm_date)=$i 
                    AND YEAR(balirealtyhv.confirm_date)='2018' 
                ...
                $maxresult = $max_table_sources_revenue2018->result();
            ...
            <?php
              if ($source=='Agent') {
                  $total_sources_revenue2018 = $this->db->query("SELECT SUM(revenue_nett) AS totalrevenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                ...
                $totalrevenue = $total_sources_revenue2018->result();
                echo '<td>' .number_format($totalrevenue['0']->totalrevenue). '</td>';          
            ?>
        ...
        <tr>
          ...
          <?php
            ...
            while($i <= 12) {
              if ($source=='Agent') {
                  $table_sources_revenue2019 = $this->db->query("SELECT SUM(revenue_nett) AS revenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                    WHERE MONTH(balirealtyhv.confirm_date)=$i 
                    AND YEAR(balirealtyhv.confirm_date)='2019' 
                ...
                $result = $table_sources_revenue2019->result();
            ...
            $i = 1;
              while($i <= 12) {
                if ($source=='Agent') {
                  $max_table_sources_revenue2019 = $this->db->query("SELECT SUM(revenue_nett) AS revenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                    WHERE MONTH(balirealtyhv.confirm_date)=$i 
                    AND YEAR(balirealtyhv.confirm_date)='2019' 
                ...
                $maxresult = $max_table_sources_revenue2019->result();
            ...
            <?php
              if ($source=='Agent') {
                  $total_sources_revenue2019 = $this->db->query("SELECT SUM(revenue_nett) AS totalrevenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                ...
                $totalrevenue = $total_sources_revenue2019->result();
                echo '<td>' .number_format($totalrevenue['0']->totalrevenue). '</td>';          
            ?>
        ...
        <tr>
          ...
          <?php
            ...
            while($i <= 12) {
              if ($source=='Agent') {
                  $table_sources_revenue2020 = $this->db->query("SELECT SUM(revenue_nett) AS revenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                    WHERE MONTH(balirealtyhv.confirm_date)=$i 
                    AND YEAR(balirealtyhv.confirm_date)='2020' 
                ...
                $result = $table_sources_revenue2020->result();
            ...
            $i = 1;
              while($i <= 12) {
                if ($source=='Agent') {
                  $max_table_sources_revenue2020 = $this->db->query("SELECT SUM(revenue_nett) AS revenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                    WHERE MONTH(balirealtyhv.confirm_date)=$i 
                    AND YEAR(balirealtyhv.confirm_date)='2020' 
                ...
                $maxresult = $max_table_sources_revenue2020->result();
            ...
            <?php
              if ($source=='Agent') {
                  $total_sources_revenue2020 = $this->db->query("SELECT SUM(revenue_nett) AS totalrevenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                ...
                $totalrevenue = $total_sources_revenue2020->result();
                echo '<td>' .number_format($totalrevenue['0']->totalrevenue). '</td>';          
            ?>
        ...
        <tr>
          ...
          <?php
            ...
            while($i <= 12) {
              if ($source=='Agent') {
                  $table_sources_revenue2021 = $this->db->query("SELECT SUM(revenue_nett) AS revenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                    WHERE MONTH(balirealtyhv.confirm_date)=$i 
                    AND YEAR(balirealtyhv.confirm_date)='2021' 
                ...
                $result = $table_sources_revenue2021->result();
            ...
            $i = 1;
              while($i <= 12) {
                if ($source=='Agent') {
                  $max_table_sources_revenue2021 = $this->db->query("SELECT SUM(revenue_nett) AS revenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                    WHERE MONTH(balirealtyhv.confirm_date)=$i 
                    AND YEAR(balirealtyhv.confirm_date)='2021' 
                ...
                $maxresult = $max_table_sources_revenue2021->result();
            ...
            <?php
              if ($source=='Agent') {
                  $total_sources_revenue2021 = $this->db->query("SELECT SUM(revenue_nett) AS totalrevenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                ...
                $totalrevenue = $total_sources_revenue2021->result();
                echo '<td>' .number_format($totalrevenue['0']->totalrevenue). '</td>';          
            ?>
        ...
        <tr>
          ...
          <?php
            ...
            while($i <= 12) {
              if ($source=='Agent') {
                  $table_sources_revenue2022 = $this->db->query("SELECT SUM(revenue_nett) AS revenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                    WHERE MONTH(balirealtyhv.confirm_date)=$i 
                    AND YEAR(balirealtyhv.confirm_date)='2022' 
                ...
                $result = $table_sources_revenue2022->result();
            ...
            $i = 1;
              while($i <= 12) {
                if ($source=='Agent') {
                  $max_table_sources_revenue2022 = $this->db->query("SELECT SUM(revenue_nett) AS revenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                    WHERE MONTH(balirealtyhv.confirm_date)=$i 
                    AND YEAR(balirealtyhv.confirm_date)='2022' 
                ...
                $maxresult = $max_table_sources_revenue2022->result();
            ...
            <?php
              if ($source=='Agent') {
                  $total_sources_revenue2022 = $this->db->query("SELECT SUM(revenue_nett) AS totalrevenue FROM balirealtyhv 
                    LEFT JOIN source ON source.source_id=balirealtyhv.source_id 
                    LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                ...
                $totalrevenue = $total_sources_revenue2022->result();
                echo '<td>' .number_format($totalrevenue['0']->totalrevenue). '</td>';          
            ?>
