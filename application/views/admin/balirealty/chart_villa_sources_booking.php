...
<script type="text/javascript">
  $(document).ready( function () {
      $('#chartVillaSourcesBooking').DataTable({
...
<div class="table-responsive"> 
  <table class="table table-bordered table-brhv" id="chartVillaSourcesBooking">
    <caption class="table-caption">Booking</caption>
      ...
      <tbody>
        ...
        <tr>
          ...
          <?php
            ...
            while($i <= 12) {
              ...
              if ($agent_booking->num_rows() != "0") {
                echo '<td>' . $agent_booking->num_rows(). '</td>'; 
              } else {
                echo '<td>-</td>'; 
              }
            $i++;
          ...
          <?php
              ...
              if ($total_agent_booking->num_rows() != "0") {
                echo '<td style="color: red;"><b>' . $total_agent_booking->num_rows(). '</b></td>'; 
              } else {
                echo '<td>-</td>'; 
              }
          ?>
        ...
        <tr>
          ...
          <?php
            ...
            while($i <= 12) {
              ...
              if ($website_booking->num_rows() != "0") {
                echo '<td>' . $website_booking->num_rows(). '</td>'; 
              } else {
                echo '<td>-</td>'; 
              }
            $i++;
          ...
          ?>
          <?php
              $total_website_booking = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN source ON source.source_id = balirealtyhv.source_id
              LEFT JOIN villa ON villa.villa_id = balirealtyhv.villa_id
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              ...
              if ($total_website_booking->num_rows() != "0") {
                echo '<td style="color: red;"><b>' . $total_website_booking->num_rows(). '</b></td>'; 
              } else {
                echo '<td>-</td>'; 
              }
          ?>
        ...
        <tr>
          ...
          <?php
            ...
            while($i <= 12) {
              ...
              if ($ota_booking->num_rows() != "0") {
                echo '<td>' . $ota_booking->num_rows(). '</td>'; 
              } else {
                echo '<td>-</td>'; 
              }
              $i++;
          ...
          ?>
          <?php
              $total_ota_booking = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN source ON source.source_id = balirealtyhv.source_id
              LEFT JOIN villa ON villa.villa_id = balirealtyhv.villa_id
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              ...
              if ($total_ota_booking->num_rows() != "0") {
                echo '<td style="color: red;"><b>' . $total_ota_booking->num_rows(). '</b></td>'; 
              } else {
                echo '<td>-</td>'; 
              }
            }        
        ...
        <tr>
          ...
          <?php
            ...
            while($i <= 12) {
              ...
              if ($others_booking->num_rows() != "0") {
                echo '<td>' . $others_booking->num_rows(). '</td>'; 
              } else {
                echo '<td>-</td>'; 
              }
              $i++;
          ...
          ?>
          <?php
              $total_others_booking = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN source ON source.source_id = balirealtyhv.source_id
              LEFT JOIN villa ON villa.villa_id = balirealtyhv.villa_id
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              ...
              if ($total_others_booking->num_rows() != "0") {
                echo '<td style="color: red;"><b>' . $total_others_booking->num_rows(). '</b></td>'; 
              } else {
                echo '<td>-</td>'; 
              }
            }        
      ...
      <tfoot>
        <tr>
          ...
          <?php
            $i = 1;
            while($i <= 12) {
              $total_booking_monthly = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN source ON source.source_id = balirealtyhv.source_id
              LEFT JOIN villa ON villa.villa_id = balirealtyhv.villa_id
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              ...
              if ($total_booking_monthly->num_rows() != "0") {
                echo '<th style="color: red;"><b>' . $total_booking_monthly->num_rows(). '</b></th>'; 
              } else {
                echo '<th>-</th>'; 
              }
            $i++;
          ...
          ?>
          <?php
              $total_booking_yearly = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN source ON source.source_id = balirealtyhv.source_id
              LEFT JOIN villa ON villa.villa_id = balirealtyhv.villa_id
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              ...
              if ($total_booking_yearly->num_rows() != "0") {
                echo '<th style="color: red;"><b>' . $total_booking_yearly->num_rows(). '</b></th>'; 
              } else {
                echo '<th>' . $total_booking_yearly->num_rows(). '</th>'; 
              }
          ?>
        </tr>
    </tfoot>
