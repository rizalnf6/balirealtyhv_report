...
<div class="container">
	...
	<div class="table-responsive">          
	  	<table class="table table-striped table-brhv" id="villaManager">
	    <thead>
	      <tr>
	        <th>#</th>
	        <th>Manager</th>
	    ...
	    <tbody>
	      ...
	      <?php
				...
				foreach($list_villa_manager as $row){
					?>
					<tr>
						<td><?php echo $no;?></td>
						...
						<td>
							<div class="action-button">
								<a href="<?php echo $button_detail."/".$row->manager_id;; ?>">
									<span class='glyphicon glyphicon-eye-open' aria-hidden='true'></span>
								</a> 
								<a href="<?php echo $button_edit."/".$row->manager_id;; ?>">
