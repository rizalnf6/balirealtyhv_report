	...
	<style type="text/css">
		.dataTables_filter {float: right!important;}
			...
			<div class="table-responsive">          
			  	<table class="table table-striped table-brhv" id="villapromotion">
			    <thead>
			      <tr>
			        <th>#</th>
			        <th>Villa</th>
			    ...
			    <?php
					...
					foreach($list_villa_promotion as $row){
				?>
					<tr>
						...
						<?php 
							...
							else { echo "<td>".nl2br($row->villa_promotion)."</td>"; }
						?>
						<?php 
