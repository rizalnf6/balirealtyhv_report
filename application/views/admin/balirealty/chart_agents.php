		...
		<div class="col-sm-8">
			...
			<div class="tab-content">
				<div id="enquiry" class="tab-pane fade in active">
				    <div class="col-sm-12">
				    	<br />
				    	<?php $this->load->view($chart_agent_enquiry); ?>
					</div> 
				</div> <!-- End div id -->
			    <div id="booking" class="tab-pane fade">
			    	<div class="col-sm-12">
			    		<br />
				    	<?php $this->load->view($chart_agent_booking); ?>
					</div> 
			    </div> 
			    <div id="revenue" class="tab-pane fade">
				    <div class="col-sm-12">
				    	<br />
				    	<?php $this->load->view($chart_agent_revenue); ?>
					</div>
			    </div>
			    <div id="conversion" class="tab-pane fade">
				    <div class="col-sm-12">
				    	<br />
				    	<?php $this->load->view($chart_agent_conversion); ?>
					</div>
			    </div>
			</div>
		</div> <!-- End col 8 -->
