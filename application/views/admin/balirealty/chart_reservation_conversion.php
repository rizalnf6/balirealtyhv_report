...
var data = {
  ...
  datasets: [{
      ...
      data: [<?php
                $i = 1;
          while($i <= 12) {
              $chart_monthly_enquiry_conversion2017 = $this->db->query("SELECT * FROM balirealtyhv 
              ...
              $chart_monthly_booking_conversion2017 = $this->db->query("SELECT * FROM balirealtyhv 
                LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                WHERE user.name='$reservation' 
      ...
      // notice the gap in the data and the spanGaps: false
       data: [<?php
                $i = 1;
          while($i <= 12) {
              $chart_monthly_enquiry_conversion2018 = $this->db->query("SELECT * FROM balirealtyhv 
                LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balirealtyhv.enquiry_date)=$i 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balirealtyhv.balirealtyhv_status='1'");
              $chart_monthly_booking_conversion2018 = $this->db->query("SELECT * FROM balirealtyhv 
                LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balirealtyhv.confirm_date)=$i 
      ...
      // notice the gap in the data and the spanGaps: false
       data: [<?php
                $i = 1;
          while($i <= 12) {
              $chart_monthly_enquiry_conversion2019 = $this->db->query("SELECT * FROM balirealtyhv 
                LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balirealtyhv.enquiry_date)=$i 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balirealtyhv.balirealtyhv_status='1'");
              $chart_monthly_booking_conversion2019 = $this->db->query("SELECT * FROM balirealtyhv 
                LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balirealtyhv.confirm_date)=$i 
      ...
      // notice the gap in the data and the spanGaps: false
       data: [<?php
                $i = 1;
          while($i <= 12) {
              $chart_monthly_enquiry_conversion2020 = $this->db->query("SELECT * FROM balirealtyhv 
                LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balirealtyhv.enquiry_date)=$i 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balirealtyhv.balirealtyhv_status='1'");
              $chart_monthly_booking_conversion2020 = $this->db->query("SELECT * FROM balirealtyhv 
                LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balirealtyhv.confirm_date)=$i 
      ...
      // notice the gap in the data and the spanGaps: false
       data: [<?php
                $i = 1;
          while($i <= 12) {
              $chart_monthly_enquiry_conversion2021 = $this->db->query("SELECT * FROM balirealtyhv 
                LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balirealtyhv.enquiry_date)=$i 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balirealtyhv.balirealtyhv_status='1'");
              $chart_monthly_booking_conversion2021 = $this->db->query("SELECT * FROM balirealtyhv 
                LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balirealtyhv.confirm_date)=$i 
      ...
      // notice the gap in the data and the spanGaps: false
       data: [<?php
                $i = 1;
          while($i <= 12) {
              $chart_monthly_enquiry_conversion2022 = $this->db->query("SELECT * FROM balirealtyhv 
                LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balirealtyhv.enquiry_date)=$i 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balirealtyhv.balirealtyhv_status='1'");
              $chart_monthly_booking_conversion2022 = $this->db->query("SELECT * FROM balirealtyhv 
                LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balirealtyhv.confirm_date)=$i 
...
<div class="table-responsive">          
  <table class="table table-bordered table-brhv">
    <caption class="table-caption">Conversion</caption>
      <thead>
        <tr>
          <th>Conversion</th>
            <?php
      ...
      <tbody>
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 12) {
              $table_monthly_enquiry_conversion2017 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balirealtyhv.balirealtyhv_status='1'");
              $table_monthly_booking_conversion2017 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.confirm_date)=$i 
            ...
            $i = 1;
            while($i <= 12) {
              $max_table_monthly_enquiry_conversion2017 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balirealtyhv.balirealtyhv_status='1'");
              $max_table_monthly_booking_conversion2017 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.confirm_date)=$i 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 12) {
              $table_monthly_enquiry_conversion2018 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balirealtyhv.balirealtyhv_status='1'");
              $table_monthly_booking_conversion2018 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.confirm_date)=$i 
            ...
            $i = 1;
            while($i <= 12) {
              $max_table_monthly_enquiry_conversion2018 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balirealtyhv.balirealtyhv_status='1'");
              $max_table_monthly_booking_conversion2018 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.confirm_date)=$i 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 12) {
              $table_monthly_enquiry_conversion2019 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balirealtyhv.balirealtyhv_status='1'");
              $table_monthly_booking_conversion2019 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.confirm_date)=$i 
            ...
            $i = 1;
            while($i <= 12) {
              $max_table_monthly_enquiry_conversion2019 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balirealtyhv.balirealtyhv_status='1'");
              $max_table_monthly_booking_conversion2019 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.confirm_date)=$i 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 12) {
              $table_monthly_enquiry_conversion2020 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balirealtyhv.balirealtyhv_status='1'");
              $table_monthly_booking_conversion2020 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.confirm_date)=$i 
            ...
            $i = 1;
            while($i <= 12) {
              $max_table_monthly_enquiry_conversion2020 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balirealtyhv.balirealtyhv_status='1'");
              $max_table_monthly_booking_conversion2020 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.confirm_date)=$i 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 12) {
              $table_monthly_enquiry_conversion2021 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balirealtyhv.balirealtyhv_status='1'");
              $table_monthly_booking_conversion2021 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.confirm_date)=$i 
            ...
            $i = 1;
            while($i <= 12) {
              $max_table_monthly_enquiry_conversion2021 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balirealtyhv.balirealtyhv_status='1'");
              $max_table_monthly_booking_conversion2021 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.confirm_date)=$i 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 12) {
              $table_monthly_enquiry_conversion2022 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balirealtyhv.balirealtyhv_status='1'");
              $table_monthly_booking_conversion2022 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.confirm_date)=$i 
            ...
            $i = 1;
            while($i <= 12) {
              $max_table_monthly_enquiry_conversion2022 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balirealtyhv.balirealtyhv_status='1'");
              $max_table_monthly_booking_conversion2022 = $this->db->query("SELECT * FROM balirealtyhv 
              LEFT JOIN user ON user.user_id=balirealtyhv.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balirealtyhv.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balirealtyhv.confirm_date)=$i 
