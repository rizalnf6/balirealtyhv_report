...
<script type="text/javascript">
  $(document).ready( function () {
      $('#chartReservationCancelation').DataTable({
...
<div class="table-responsive"> 
  <table class="table table-bordered table-brhv" id="chartReservationCancelation">
    <caption class="table-caption">Cancelation Reason of <?php echo $reservation." at ".$year; ?></caption>
      <thead>
        <tr>
        ...
        <tr>
          ...
          <?php
            ...
            while($i <= 12) {
              ...
              AND cancelation.cancelation='$row->cancelation' 
