...
var data = {
  ...
  datasets: [{
      ...
      data: [<?php
          ...
          while($i <= 31)
          {
              $chart_daily_enquiry_conversion2017 = $this->db->query("SELECT * FROM balivillaescapes 
              ...
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              AND YEAR(balivillaescapes.enquiry_date)='2017' 
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') AND balivillaescapes.balivillaescapes_status='1'");
              $chart_daily_booking_conversion2017 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
      ...
      data: [<?php
          ...
          while($i <= 31)
          {
              $chart_daily_enquiry_conversion2018 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') AND balivillaescapes.balivillaescapes_status='1'");
              $chart_daily_booking_conversion2018 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.confirm_date)=$i 
              AND MONTH(balivillaescapes.confirm_date)=$month 
      ...
      data: [<?php
          ...
          while($i <= 31)
          {
              $chart_daily_enquiry_conversion2019 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') AND balivillaescapes.balivillaescapes_status='1'");
              $chart_daily_booking_conversion2019 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.confirm_date)=$i 
              AND MONTH(balivillaescapes.confirm_date)=$month 
      ...
      data: [<?php
          ...
          while($i <= 31)
          {
              $chart_daily_enquiry_conversion2020 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') AND balivillaescapes.balivillaescapes_status='1'");
              $chart_daily_booking_conversion2020 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.confirm_date)=$i 
              AND MONTH(balivillaescapes.confirm_date)=$month 
      ...
      data: [<?php
          ...
          while($i <= 31)
          {
              $chart_daily_enquiry_conversion2021 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') AND balivillaescapes.balivillaescapes_status='1'");
              $chart_daily_booking_conversion2021 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.confirm_date)=$i 
              AND MONTH(balivillaescapes.confirm_date)=$month 
      ...
      data: [<?php
          ...
          while($i <= 31)
          {
              $chart_daily_enquiry_conversion2022 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') AND balivillaescapes.balivillaescapes_status='1'");
              $chart_daily_booking_conversion2022 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.confirm_date)=$i 
              AND MONTH(balivillaescapes.confirm_date)=$month 
...
<div class="table-responsive">          
  <table class="table table-bordered table-bve">
    <caption><?php echo "Conversion of ".date("F", mktime(0, 0, 0, $month, 10)); ?></caption>
      <thead>
        <tr>
          <th>Conversion</th>
          <?php
      ...
      <tbody>
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 31) {
              $table_daily_enquiry_conversion2017 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              AND YEAR(balivillaescapes.enquiry_date)='2017' AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $table_daily_booking_conversion2017 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.confirm_date)=$i 
              AND MONTH(balivillaescapes.confirm_date)=$month 
            ...
            $i = 1;
            while($i <= 31) {
              $max_table_daily_enquiry_conversion2017 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              AND YEAR(balivillaescapes.enquiry_date)='2017' AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $max_table_daily_booking_conversion2017 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.confirm_date)=$i 
              AND MONTH(balivillaescapes.confirm_date)=$month 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 31) {
              $table_daily_enquiry_conversion2018 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              AND YEAR(balivillaescapes.enquiry_date)='2018' AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $table_daily_booking_conversion2018 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.confirm_date)=$i 
              AND MONTH(balivillaescapes.confirm_date)=$month 
            ...
            $i = 1;
            while($i <= 31) {
              $max_table_daily_enquiry_conversion2018 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              AND YEAR(balivillaescapes.enquiry_date)='2018' AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $max_table_daily_booking_conversion2018 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.confirm_date)=$i 
              AND MONTH(balivillaescapes.confirm_date)=$month 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 31) {
              $table_daily_enquiry_conversion2019 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              AND YEAR(balivillaescapes.enquiry_date)='2019' AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $table_daily_booking_conversion2019 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.confirm_date)=$i 
              AND MONTH(balivillaescapes.confirm_date)=$month 
            ...
            $i = 1;
            while($i <= 31) {
              $max_table_daily_enquiry_conversion2019 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              AND YEAR(balivillaescapes.enquiry_date)='2019' AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $max_table_daily_booking_conversion2019 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.confirm_date)=$i 
              AND MONTH(balivillaescapes.confirm_date)=$month 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 31) {
              $table_daily_enquiry_conversion2020 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              AND YEAR(balivillaescapes.enquiry_date)='2020' AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $table_daily_booking_conversion2020 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.confirm_date)=$i 
              AND MONTH(balivillaescapes.confirm_date)=$month 
            ...
            $i = 1;
            while($i <= 31) {
              $max_table_daily_enquiry_conversion2020 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              AND YEAR(balivillaescapes.enquiry_date)='2020' AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $max_table_daily_booking_conversion2020 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.confirm_date)=$i 
              AND MONTH(balivillaescapes.confirm_date)=$month 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 31) {
              $table_daily_enquiry_conversion2021 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              AND YEAR(balivillaescapes.enquiry_date)='2021' AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $table_daily_booking_conversion2021 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.confirm_date)=$i 
              AND MONTH(balivillaescapes.confirm_date)=$month 
            ...
            $i = 1;
            while($i <= 31) {
              $max_table_daily_enquiry_conversion2021 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              AND YEAR(balivillaescapes.enquiry_date)='2021' AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $max_table_daily_booking_conversion2021 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.confirm_date)=$i 
              AND MONTH(balivillaescapes.confirm_date)=$month 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 31) {
              $table_daily_enquiry_conversion2022 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              AND YEAR(balivillaescapes.enquiry_date)='2022' AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $table_daily_booking_conversion2022 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.confirm_date)=$i 
              AND MONTH(balivillaescapes.confirm_date)=$month 
            ...
            $i = 1;
            while($i <= 31) {
              $max_table_daily_enquiry_conversion2022 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.enquiry_date)=$i 
              AND MONTH(balivillaescapes.enquiry_date)=$month 
              AND YEAR(balivillaescapes.enquiry_date)='2022' AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $max_table_daily_booking_conversion2022 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE DAY(balivillaescapes.confirm_date)=$i 
              AND MONTH(balivillaescapes.confirm_date)=$month 
