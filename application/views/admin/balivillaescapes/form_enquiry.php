		...
		<div class="col-sm-10">
			<form method="post" class="form-horizontal" name="MyForm" onsubmit="return(validate())">
				...
				<div class="col-sm-12">
					...
					<div class="col-sm-4">
						<div class="form-group form-group-md">
							<input type="email" class="form-control input-md" name="guest_email" 
						value="<?php if(isset($default['guest_email'])) {echo $default['guest_email'];} ?>">
						</div> <!--Form Group End -->
					</div> <!--End col-sm-3 -->
					<div class="col-sm-2" align="center">
						<div class="form-group form-group-md">
					...
					<div class="col-sm-4">
						<div class="form-group form-group-md">
							<input type="date" class="form-control" name="confirm_date" 
								value="<?php if(isset($default['confirm_date'])){echo $default['confirm_date'];}?>">
						</div> <!--Form Group End -->
					</div> <!--End col-sm-3 -->
					<div class="col-sm-2" align="center">
						<div class="form-group form-group-md">
				...
				<div class="col-sm-12">
					...
					<div class="col-sm-4">
						<div class="form-group form-group-md">
							<input type="number" class="form-control" name="revenue_nett_aud" 
								value="<?php if(isset($default['revenue_nett_aud'])){echo $default['revenue_nett_aud'];}?>">
						</div> <!--Form Group End -->
					</div> <!--End col-sm-3 -->
					<div class="col-sm-2" align="center">
						<div class="form-group form-group-md">
					...
					<div class="col-sm-4">
						<div class="form-group form-group-md">
							<input type="number" class="form-control" name="revenue_gross_aud" 
								value="<?php if(isset($default['revenue_gross_aud'])){echo $default['revenue_gross_aud'];}?>">
						</div> <!--Form Group End -->
					</div> <!--End col-sm-3 -->
				</div> <!--End col-sm-12 -->
				<div class="col-sm-12">
					...
					<div class="col-sm-4">
						<div class="form-group form-group-md">
							<input type="number" class="form-control" name="revenue_nett_usd" 
								value="<?php if(isset($default['revenue_nett_usd'])){echo $default['revenue_nett_usd'];}?>">
						</div> <!--Form Group End -->
					</div> <!--End col-sm-3 -->
					<div class="col-sm-2" align="center">
						<div class="form-group form-group-md">
					...
					<div class="col-sm-4">
						<div class="form-group form-group-md">
							<input type="number" class="form-control" name="revenue_gross_usd" 
								value="<?php if(isset($default['revenue_gross_usd'])){echo $default['revenue_gross_usd'];}?>">
						</div> <!--Form Group End -->
					</div> <!--End col-sm-3 -->
				</div> <!--End col-sm-12 -->
