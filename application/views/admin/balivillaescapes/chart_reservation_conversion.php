...
var data = {
  ...
  datasets: [{
      ...
      data: [<?php
		            $i = 1;
					while($i <= 12) {
					    $chart_monthly_enquiry_conversion2017 = $this->db->query("SELECT * FROM balivillaescapes 
                ...
                AND MONTH(balivillaescapes.enquiry_date)=$i 
              ...
              $chart_monthly_booking_conversion2017 = $this->db->query("SELECT * FROM balivillaescapes 
                LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
                WHERE user.name='$reservation' 
      ...
      // notice the gap in the data and the spanGaps: false
       data: [<?php
                $i = 1;
          while($i <= 12) {
              $chart_monthly_enquiry_conversion2018 = $this->db->query("SELECT * FROM balivillaescapes 
                LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balivillaescapes.enquiry_date)=$i 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillaescapes.balivillaescapes_status='1'");
              $chart_monthly_booking_conversion2018 = $this->db->query("SELECT * FROM balivillaescapes 
                LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balivillaescapes.confirm_date)=$i 
      ...
      // notice the gap in the data and the spanGaps: false
       data: [<?php
                $i = 1;
          while($i <= 12) {
              $chart_monthly_enquiry_conversion2019 = $this->db->query("SELECT * FROM balivillaescapes 
                LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balivillaescapes.enquiry_date)=$i 
                ...
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillaescapes.balivillaescapes_status='1'");
              $chart_monthly_booking_conversion2019 = $this->db->query("SELECT * FROM balivillaescapes 
                LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balivillaescapes.confirm_date)=$i 
      ...
      // notice the gap in the data and the spanGaps: false
       data: [<?php
                $i = 1;
          while($i <= 12) {
              $chart_monthly_enquiry_conversion2020 = $this->db->query("SELECT * FROM balivillaescapes 
                LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balivillaescapes.enquiry_date)=$i 
                AND YEAR(balivillaescapes.enquiry_date)='2020' 
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillaescapes.balivillaescapes_status='1'");
              $chart_monthly_booking_conversion2020 = $this->db->query("SELECT * FROM balivillaescapes 
                LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balivillaescapes.confirm_date)=$i 
      ...
      // notice the gap in the data and the spanGaps: false
       data: [<?php
                $i = 1;
          while($i <= 12) {
              $chart_monthly_enquiry_conversion2021 = $this->db->query("SELECT * FROM balivillaescapes 
                LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balivillaescapes.enquiry_date)=$i 
                AND YEAR(balivillaescapes.enquiry_date)='2021' 
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillaescapes.balivillaescapes_status='1'");
              $chart_monthly_booking_conversion2021 = $this->db->query("SELECT * FROM balivillaescapes 
                LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balivillaescapes.confirm_date)=$i 
              ...
              if ($chart_monthly_enquiry_conversion2021->num_rows()=="0" OR $chart_monthly_booking_conversion2021->num_rows()=="0") {
                echo '"0",';
              } else {
                $chart_conversion2021 = (($chart_monthly_booking_conversion2021->num_rows()/$chart_monthly_enquiry_conversion2021->num_rows())*100);
      ...
      // notice the gap in the data and the spanGaps: false
       data: [<?php
                $i = 1;
          while($i <= 12) {
              $chart_monthly_enquiry_conversion2022 = $this->db->query("SELECT * FROM balivillaescapes 
                LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balivillaescapes.enquiry_date)=$i 
                AND YEAR(balivillaescapes.enquiry_date)='2022' 
                AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
                AND balivillaescapes.balivillaescapes_status='1'");
              $chart_monthly_booking_conversion2022 = $this->db->query("SELECT * FROM balivillaescapes 
                LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
                WHERE user.name='$reservation' 
                AND MONTH(balivillaescapes.confirm_date)=$i 
              ...
              if ($chart_monthly_enquiry_conversion2022->num_rows()=="0" OR $chart_monthly_booking_conversion2022->num_rows()=="0") {
                echo '"0",';
              } else {
                $chart_conversion2022 = (($chart_monthly_booking_conversion2022->num_rows()/$chart_monthly_enquiry_conversion2022->num_rows())*100);
      ...
      <tbody>
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 12) {
              $table_monthly_enquiry_conversion2017 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $table_monthly_booking_conversion2017 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.confirm_date)=$i 
            ...
            $i = 1;
            while($i <= 12) {
              $max_table_monthly_enquiry_conversion2017 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $max_table_monthly_booking_conversion2017 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.confirm_date)=$i 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 12) {
              $table_monthly_enquiry_conversion2018 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $table_monthly_booking_conversion2018 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.confirm_date)=$i 
            ...
            $i = 1;
            while($i <= 12) {
              $max_table_monthly_enquiry_conversion2018 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $max_table_monthly_booking_conversion2018 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.confirm_date)=$i 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 12) {
              $table_monthly_enquiry_conversion2019 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $table_monthly_booking_conversion2019 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.confirm_date)=$i 
            ...
            $i = 1;
            while($i <= 12) {
              $max_table_monthly_enquiry_conversion2019 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $max_table_monthly_booking_conversion2019 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.confirm_date)=$i 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 12) {
              $table_monthly_enquiry_conversion2020 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $table_monthly_booking_conversion2020 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.confirm_date)=$i 
            ...
            $i = 1;
            while($i <= 12) {
              $max_table_monthly_enquiry_conversion2020 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $max_table_monthly_booking_conversion2020 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.confirm_date)=$i 
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 12) {
              $table_monthly_enquiry_conversion2021 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $table_monthly_booking_conversion2021 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.confirm_date)=$i 
              ...
              if ($table_monthly_enquiry_conversion2021->num_rows()=="0" OR $table_monthly_booking_conversion2021->num_rows()=="0") {
                $table_monthly_conversion2021 = "0";
              } else {
                $table_monthly_conversion2021 = (($table_monthly_booking_conversion2021->num_rows()/$table_monthly_enquiry_conversion2021->num_rows())*100);     
              }           

              if ($table_monthly_conversion2021 > $max) {
                $max = $table_monthly_conversion2021;
              }
            $i++;
            }
            ...
            $i = 1;
            while($i <= 12) {
              $max_table_monthly_enquiry_conversion2021 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $max_table_monthly_booking_conversion2021 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.confirm_date)=$i 
              ...
              if ($max_table_monthly_enquiry_conversion2021->num_rows()=="0" OR $max_table_monthly_booking_conversion2021->num_rows()=="0") {
                $max_table_monthly_conversion2021 = "0";
              } else {
                $max_table_monthly_conversion2021 = (($max_table_monthly_booking_conversion2021->num_rows()/$max_table_monthly_enquiry_conversion2021->num_rows())*100);     
              }    

              if ($max_table_monthly_conversion2021 == $max) {
                echo '<td style="background-color: rgba(138, 109, 59, 0.5); color: #fff;">' .number_format($max_table_monthly_conversion2021). '%</td>'; 
              } else {
                echo '<td>' .number_format($max_table_monthly_conversion2021). '%</td>'; 
              }
            $i++;
            }       
          ?>
        ...
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 12) {
              $table_monthly_enquiry_conversion2022 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $table_monthly_booking_conversion2022 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.confirm_date)=$i 
              ...
              if ($table_monthly_enquiry_conversion2022->num_rows()=="0" OR $table_monthly_booking_conversion2022->num_rows()=="0") {
                $table_monthly_conversion2022 = "0";
              } else {
                $table_monthly_conversion2022 = (($table_monthly_booking_conversion2022->num_rows()/$table_monthly_enquiry_conversion2022->num_rows())*100);     
              }           

              if ($table_monthly_conversion2022 > $max) {
                $max = $table_monthly_conversion2022;
              }
            $i++;
            }
            ...
            $i = 1;
            while($i <= 12) {
              $max_table_monthly_enquiry_conversion2022 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.enquiry_date)=$i 
              ...
              AND (status_enquiry.status_enquiry!='Proposed' OR status_enquiry.status_enquiry!='Extend Stay') 
              AND balivillaescapes.balivillaescapes_status='1'");
              $max_table_monthly_booking_conversion2022 = $this->db->query("SELECT * FROM balivillaescapes 
              LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
              LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
              WHERE user.name='$reservation' 
              AND MONTH(balivillaescapes.confirm_date)=$i 
              ...
              if ($max_table_monthly_enquiry_conversion2022->num_rows()=="0" OR $max_table_monthly_booking_conversion2022->num_rows()=="0") {
                $max_table_monthly_conversion2022 = "0";
              } else {
                $max_table_monthly_conversion2022 = (($max_table_monthly_booking_conversion2022->num_rows()/$max_table_monthly_enquiry_conversion2022->num_rows())*100);     
              }    

              if ($max_table_monthly_conversion2022 == $max) {
                echo '<td style="background-color: rgba(169, 68, 66, 0.5); color: #fff;">' .number_format($max_table_monthly_conversion2022). '%</td>'; 
              } else {
                echo '<td>' .number_format($max_table_monthly_conversion2022). '%</td>'; 
              }
            $i++;
            }       
          ?>
