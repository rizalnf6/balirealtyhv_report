						...
						foreach($list_confirm as $row){
							...
							<tr>
								...
								<td class="uppercase-name">
									...
									<?php 
										if ($row->balivillaescapes_status != "1") {
								...
								<?php endif ?>
								<td style="background-color:#fcf8e3;"><?php echo number_format($row->revenue_nett_aud);?></td>
								<td style="background-color:#f2dede;"><?php echo number_format($row->revenue_nett_usd);?></td>
