...
var data = {
  ...
  datasets: [{
      ...
      data: [<?php
          ...
          while($i <= 31)
          {
              $chartEnquiry = $this->db->query("SELECT * FROM balivillaescapes 
      ...
      <tbody>
        <tr>
          ...
          <?php
            ...
            $max = 0;
            while($i <= 31) {
              $tableEnquiry = $this->db->query("SELECT * FROM balivillaescapes 
                LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
                WHERE DAY(balivillaescapes.enquiry_date)=$i 
                AND MONTH(balivillaescapes.enquiry_date)=$month 
            ...
            $i = 1;
            while($i <= 31) {
              $maxTableEnquiry = $this->db->query("SELECT * FROM balivillaescapes 
                LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
                WHERE DAY(balivillaescapes.enquiry_date)=$i 
                AND MONTH(balivillaescapes.enquiry_date)=$month 
          ...
          <?php
            $totalTableEnquiry = $this->db->query("SELECT * FROM balivillaescapes 
                LEFT JOIN user ON user.user_id=balivillaescapes.reservation_id 
                LEFT JOIN status_enquiry ON status_enquiry.status_enquiry_id=balivillaescapes.status_enquiry_id 
