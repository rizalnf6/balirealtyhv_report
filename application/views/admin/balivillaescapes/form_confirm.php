			...
			<form method="post" class="form-horizontal" name="MyForm" onsubmit="return(validate())">
				...
				<div class="col-sm-2" align="center">
					...
					<div class="col-sm-4">
						<div class="form-group form-group-md">
							...
							<?php endif ?>
							<?php if ($this->session->userdata('level')=="reservation"): ?>
								<input type="email" class="form-control input-md" name="guest_email" value="<?php if(isset($default['guest_email'])) {echo $default['guest_email'];} ?>" readonly>
							<?php endif ?>
						</div> <!--Form Group End -->
					</div> <!--End col-sm-3 -->
					<div class="col-sm-2" align="center">
				...
				<div class="col-sm-12">
					...
					<div class="col-sm-4">
						<div class="form-group form-group-md">
							<?php if ($this->session->userdata('level')=="admin"): ?>
								<input type="number" class="form-control" name="revenue_nett_aud" value="<?php if(isset($default['revenue_nett_aud'])){echo $default['revenue_nett_aud'];}?>" required>
							<?php endif ?>
							<?php if ($this->session->userdata('level')=="reservation"): ?>
								<input type="number" class="form-control" name="revenue_nett_aud" value="<?php if(isset($default['revenue_nett_aud'])){echo $default['revenue_nett_aud'];}?>" required readonly>
							<?php endif ?>
						</div> <!--Form Group End -->
					</div> <!--End col-sm-3 -->
					<div class="col-sm-2" align="center">
					...
					<div class="col-sm-4">
						<div class="form-group form-group-md">
							<?php if ($this->session->userdata('level')=="admin"): ?>
								<input type="number" class="form-control" name="revenue_gross_aud" value="<?php if(isset($default['revenue_gross_aud'])){echo $default['revenue_gross_aud'];}?>" required>
							<?php endif ?>
							<?php if ($this->session->userdata('level')=="reservation"): ?>
								<input type="number" class="form-control" name="revenue_gross_aud" value="<?php if(isset($default['revenue_gross_aud'])){echo $default['revenue_gross_aud'];}?>" required readonly>
							<?php endif ?>
						</div> <!--Form Group End -->
					</div> <!--End col-sm-3 -->
				</div> <!--End col-sm-12 -->
				<div class="col-sm-12">
					...
					<div class="col-sm-4">
						<div class="form-group form-group-md">
							<?php if ($this->session->userdata('level')=="admin"): ?>
								<input type="number" class="form-control" name="revenue_nett_usd" 
								value="<?php if(isset($default['revenue_nett_usd'])){echo $default['revenue_nett_usd'];}?>" required>
							<?php endif ?>
							<?php if ($this->session->userdata('level')=="reservation"): ?>
								<input type="number" class="form-control" name="revenue_nett_usd" 
								value="<?php if(isset($default['revenue_nett_usd'])){echo $default['revenue_nett_usd'];}?>" required readonly>
							<?php endif ?>
						</div> <!--Form Group End -->
					</div> <!--End col-sm-3 -->
					<div class="col-sm-2" align="center">
					...
					<div class="col-sm-4">
						<div class="form-group form-group-md">
							<?php if ($this->session->userdata('level')=="admin"): ?>
								<input type="number" class="form-control" name="revenue_gross_usd" 
								value="<?php if(isset($default['revenue_gross_usd'])){echo $default['revenue_gross_usd'];}?>" required>
							<?php endif ?>
							<?php if ($this->session->userdata('level')=="reservation"): ?>
								<input type="number" class="form-control" name="revenue_gross_usd" 
								value="<?php if(isset($default['revenue_gross_usd'])){echo $default['revenue_gross_usd'];}?>" required readonly>
							<?php endif ?>
						</div> <!--Form Group End -->
					</div> <!--End col-sm-3 -->
				</div> <!--End col-sm-12 -->
				...
				<div class="col-sm-12">
					<br /><br />
					<h4 class="form-heading-bve"> Arrival Detail </h4>
					<br />
					<div class="col-sm-2" align="center">
						<div class="form-group form-group-md">
							<label class="control-label">
