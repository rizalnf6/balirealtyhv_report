  ...
  <div class="row">
    ...
    <div class="col-sm-5">  
      <div class="button-filter-download">
        <!--Button Edit-->
        <?php if ($default['status_enquiry'] == "Confirm" AND $default['balivillaescapes_status'] == "1" AND($this->session->userdata('level')=="admin" OR $this->session->userdata('level')=="reservation")): ?>
          <a href="<?php echo $button_edit_confirm."/".$default['report_id']; ?>">
            <button type="button" class="btn btn-filter btn-xs">Edit</button>
          </a>
        <?php endif ?>

        <?php if ($default['status_enquiry'] == "Proposed" AND $default['balivillaescapes_status'] == "1" AND($this->session->userdata('level')=="admin" OR $this->session->userdata('level')=="reservation")): ?>
          <a href="<?php echo $button_edit_propose."/".$default['report_id']; ?>">
            <button type="button" class="btn btn-filter btn-xs">Edit</button>
          </a>
        <?php endif ?>

        <?php if ($default['status_enquiry'] == "Extend Stay" AND $default['balivillaescapes_status'] == "1" AND($this->session->userdata('level')=="admin" OR $this->session->userdata('level')=="reservation")): ?>
  ...
  <div class="row">
    ...
    <div class="col-sm-10">
          ...
          <h4 class="guest_detail"><b class="label-detail">Enquiry Date : </b> 
            <?php 
              if($default['enquiry_date'] == "0000-00-00"){ 
                echo "<i style=color:red><b>Proposed / Extend Stay</b></i>"; 
              } else { $enquiry_date = Date("d F Y", strtotime($default['enquiry_date'])); 
                echo $enquiry_date;
              } 
            ?>
          </h4>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <h4 class="guest_detail"><b class="label-detail">Villa : </b> <?php if(isset($default['villa'])) {echo $default['villa'].' <br /><b style=color:#d9534f> ('.$default['management'].')</b>';} ?></h4>
        </div>
      </div> <!--End Row-->
          ...
          <h4 class="guest_detail"><b class="label-detail">Checkin Date : </b> 
            ...
            <?php 
              if($default['checkin'] > $default['checkout']){ 
                echo "<b style=color:#d9534f>Check the Date.</b>"; 
              } else { echo "";} 
            ?>
          </h4>
        </div>
      ...
      <div class="row">
        <div class="col-sm-4">
          <h4 class="guest_detail"><b class="label-detail">Revenue Nett (AUD) : </b> 
            <?php 
              if(isset($default['revenue_nett_aud'])) {
                echo number_format($default['revenue_nett_aud']);
              } 
            ?>
            <?php 
              if($default['revenue_nett_aud'] == "0" AND $default['status_enquiry'] == "Confirm"){ 
                echo "<i style=color:#d9534f>Fill the revenue.</i>"; 
              } else if($default['revenue_nett_aud'] > $default['revenue_gross_aud'] AND $default['status_enquiry'] == "Confirm"){ 
                echo "<i style=color:#d9534f>Check the revenue.</i>"; 
              } else if($default['revenue_nett_aud'] == "0" AND $default['status_enquiry'] == "Proposed"){ 
                echo "<i style=color:#d9534f>Check the revenue.</i>"; 
              } else if($default['revenue_nett_aud'] > $default['revenue_gross_aud'] AND $default['status_enquiry'] == "Proposed"){ 
                echo "<i style=color:#d9534f>Check the revenue.</i>"; 
              } else if($default['revenue_nett_aud'] == "0" AND $default['status_enquiry'] == "Extend Stay"){ 
                echo "<i style=color:#d9534f>Check the revenue.</i>"; 
              } else if($default['revenue_nett_aud'] > $default['revenue_gross_aud'] AND $default['status_enquiry'] == "Extend Stay"){ 
                echo "<i style=color:#d9534f>Check the revenue.</i>"; 
              } else { echo "";}
            ?>
          </h4>
        ...
        <div class="col-sm-4">
          <h4 class="guest_detail"><b class="label-detail">Revenue Gross (AUD) : </b> 
            <?php 
              if(isset($default['revenue_gross_aud'])) {
                echo number_format($default['revenue_gross_aud']);
              } 
            ?>
            <?php 
              if($default['revenue_gross_aud'] == "0" AND $default['status_enquiry'] == "Confirm"){ 
                echo "<i style=color:#d9534f>Fill the revenue.</i>"; 
              } else if($default['revenue_nett_aud'] > $default['revenue_gross_aud'] AND $default['status_enquiry'] == "Confirm"){ 
                echo "<i style=color:#d9534f>Check the revenue.</i>"; 
              } else if($default['revenue_nett_aud'] == "0" AND $default['status_enquiry'] == "Proposed"){ 
      ...
      <div class="row">
        <div class="col-sm-4">
          <h4 class="guest_detail"><b class="label-detail">Revenue Nett (USD) : </b> 
            <?php 
              if(isset($default['revenue_nett_usd'])) {
                echo number_format($default['revenue_nett_usd']);
              } 
            ?>
            <?php 
              if($default['revenue_nett_usd'] == "0" AND $default['status_enquiry'] == "Confirm"){ 
                echo "<i style=color:#d9534f>Fill the revenue.</i>"; 
              } else if($default['revenue_nett_usd'] > $default['revenue_gross_usd'] AND $default['status_enquiry'] == "Confirm"){ 
                echo "<i style=color:#d9534f>Check the revenue.</i>"; 
              } else if($default['revenue_nett_usd'] == "0" AND $default['status_enquiry'] == "Proposed"){ 
                echo "<i style=color:#d9534f>Check the revenue.</i>"; 
              } else if($default['revenue_nett_usd'] > $default['revenue_gross_usd'] AND $default['status_enquiry'] == "Proposed"){ 
                echo "<i style=color:#d9534f>Check the revenue.</i>"; 
              } else if($default['revenue_nett_usd'] == "0" AND $default['status_enquiry'] == "Extend Stay"){ 
                echo "<i style=color:#d9534f>Check the revenue.</i>"; 
              } else if($default['revenue_nett_usd'] > $default['revenue_gross_usd'] AND $default['status_enquiry'] == "Extend Stay"){ 
                echo "<i style=color:#d9534f>Check the revenue.</i>"; 
              } else { echo "";}
            ?>
          </h4>
        ...
        <div class="col-sm-4">
          <h4 class="guest_detail"><b class="label-detail">Revenue Gross (USD) : </b> 
            <?php 
              if(isset($default['revenue_gross_usd'])) {
                echo number_format($default['revenue_gross_usd']);
              } 
            ?>
            <?php 
              if($default['revenue_gross_usd'] == "0" AND $default['status_enquiry'] == "Confirm"){ 
                echo "<i style=color:#d9534f>Fill the revenue.</i>"; 
              } else if($default['revenue_nett_usd'] > $default['revenue_gross_usd'] AND $default['status_enquiry'] == "Confirm"){ 
                echo "<i style=color:#d9534f>Check the revenue.</i>"; 
              } else if($default['revenue_nett_usd'] == "0" AND $default['status_enquiry'] == "Proposed"){ 
      ...
      <hr /> <h3 class="form-heading-details-bve">Arrival Details</h3>
