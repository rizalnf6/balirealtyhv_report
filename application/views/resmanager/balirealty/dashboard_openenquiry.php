...
<div class="table-responsive table-scroll">         
  	<table class="table table-bordered table-brhv">
		...
		<tbody>
		    <?php 
		    	$brhvOpen = $this->db->query("SELECT * FROM balirealtyhv  
					...
					$date2 = date_create($today);
						...
						if ($diff->format("%a")>1) {
							...
							<div class='action-button'>
								<a href='".base_url('resmanager/brhv_enquiry/details')."/".$row->report_id."'>
