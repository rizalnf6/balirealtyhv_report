				...
				<div class="well well-sm">
					<?php 
						$reservation = $this->input->get('reservation');
							if (empty($reservation)) { echo "<p style='color:#000;'>No reservation selected</p>";} 

							elseif (!empty($reservation)) { echo "Result from all of the enquiries by<br /><b style='color:#e84c3d;'>".$reservation."</b>" ;} 
					?>
				</div>
			</div>
			<div class="col-xs-12">
