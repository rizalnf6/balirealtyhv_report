...
class Bve_confirm extends CI_Controller {
	...
	public function confirm($report_id=NULL) {
		...
		$config['base_url'] = base_url().'bveonly/bve_confirm/confirm';
	...
	public function details($report_id) {
		...
		$data['button_edit_confirm'] = base_url().'bveonly/bve_confirm/edit';
		$data['button_edit_propose'] = base_url().'bveonly/bve_propose_extend/edit_propose';
		$data['button_edit_extend'] = base_url().'bveonly/bve_propose_extend/edit_extend';
		$data['button_extend'] = base_url().'bveonly/bve_propose_extend/extend';
		$data['button_delete'] = base_url().'bveonly/bve_confirm/delete';
		$data['button_print'] = base_url().'bveonly/export/pdf_brhv_report';
	...
	public function edit($report_id) {
		...
		redirect("bveonly/bve_confirm/confirm");
		}
