...
class Brhv_confirm extends CI_Controller {
	...
	public function confirm($report_id=NULL) {
		...
		$config['base_url'] = base_url().'resmanager/brhv_confirm/confirm';
	...
	public function details($report_id) {
		...
		$data['button_extend'] = base_url().'resmanager/brhv_propose_extend/extend';
		$data['button_delete'] = base_url().'resmanager/brhv_confirm/delete';
		$data['button_print'] = base_url().'resmanager/export/pdf_brhv_report';
	...
	public function edit($report_id) {
		...
		redirect("resmanager/brhv_confirm/confirm");
		}
