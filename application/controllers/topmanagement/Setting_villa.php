...
class Setting_villa extends CI_Controller {
	...
	public function index() {
		...
		$data['button_add'] = base_url().'topmanagement/setting_villa/add';
		$data['button_detail'] = base_url().'topmanagement/setting_villa/details';
		$data['button_edit'] = base_url().'topmanagement/setting_villa/edit';
		$data['button_delete'] = base_url().'topmanagement/setting_villa/delete';
	...
	public function add() {
		...
		if(isset($_POST['submit'])){
			...
			redirect("topmanagement/setting_villa");
		}
