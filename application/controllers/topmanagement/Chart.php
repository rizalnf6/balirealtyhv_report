...
class Chart extends CI_Controller {
	...
	public function brhv() {
		...
		$data['buttonDaily'] = base_url().'topmanagement/chart/brhv_daily';
		$data['buttonMonthly'] = base_url().'topmanagement/chart/brhv_monthly';
		$data['buttonVilla'] = base_url().'topmanagement/chart/brhv_villa';
		$data['buttonVillaSources'] = base_url().'topmanagement/chart/brhv_villa_sources';
		$data['buttonCancelation'] = base_url().'topmanagement/chart/brhv_cancelation';
		$data['buttonReservationCancelation'] = base_url().'topmanagement/chart/brhv_reservation_cancelation';
		$data['buttonSources'] = base_url().'topmanagement/chart/brhv_sources';
		$data['buttonAgents'] = base_url().'topmanagement/chart/brhv_agents';
		$data['buttonReservation'] = base_url().'topmanagement/chart/brhv_reservation';
		$data['buttonGuestComparison'] = base_url().'topmanagement/chart/brhv_guest_comparison';
		$data['buttonCovid19'] = base_url().'topmanagement/chart/brhv_covid19';
	...
	public function bve() {
		...
		$data['buttonDaily'] = base_url().'topmanagement/chart/bve_daily';
		$data['buttonMonthly'] = base_url().'topmanagement/chart/bve_monthly';
		$data['buttonReservation'] = base_url().'topmanagement/chart/bve_reservation';
	...
	public function bvo() {
		...
		$data['buttonDaily'] = base_url().'topmanagement/chart/bvo_daily';
		$data['buttonMonthly'] = base_url().'topmanagement/chart/bvo_monthly';
		$data['buttonReservation'] = base_url().'topmanagement/chart/bvo_reservation';
