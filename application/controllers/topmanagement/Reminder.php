...
class Reminder extends CI_Controller {
	...
	public function brhv() {
		...
		$data['button_detail_enquiry'] = base_url().'topmanagement/brhv_enquiry/details';
		$data['button_detail_confirm'] = base_url().'topmanagement/brhv_confirm/details';
		$data['button_edit_enquiry'] = base_url().'topmanagement/brhv_enquiry/edit';
		$data['button_edit_confirm'] = base_url().'topmanagement/brhv_confirm/edit';
		$data['button_edit_extend'] = base_url().'topmanagement/brhv_propose_extend/edit_extend';
		$data['button_edit_propose'] = base_url().'topmanagement/brhv_propose_extend/edit_propose';
		$data['button_delete'] = base_url().'topmanagement/brhv_confirm/delete';
	...
	public function bve() {
		...
		$data['button_detail_enquiry'] = base_url().'topmanagement/bve_enquiry/details';
		$data['button_detail_confirm'] = base_url().'topmanagement/bve_confirm/details';
		$data['button_edit_enquiry'] = base_url().'topmanagement/bve_enquiry/edit';
		$data['button_edit_confirm'] = base_url().'topmanagement/bve_confirm/edit';
		$data['button_edit_extend'] = base_url().'topmanagement/bve_propose_extend/edit_extend';
		$data['button_edit_propose'] = base_url().'topmanagement/bve_propose_extend/edit_propose';
		$data['button_delete'] = base_url().'topmanagement/bve_confirm/delete';
	...
	public function bvo() {
		...
		$data['button_detail_enquiry'] = base_url().'topmanagement/bvo_enquiry/details';
		$data['button_detail_confirm'] = base_url().'topmanagement/bvo_confirm/details';
		$data['button_edit_enquiry'] = base_url().'topmanagement/bve_enquiry/edit';
		$data['button_edit_confirm'] = base_url().'topmanagement/bvo_confirm/edit';
		$data['button_edit_extend'] = base_url().'topmanagement/bvo_propose_extend/edit_extend';
		$data['button_edit_propose'] = base_url().'topmanagement/bvo_propose_extend/edit_propose';
		$data['button_delete'] = base_url().'topmanagement/bvo_confirm/delete';
