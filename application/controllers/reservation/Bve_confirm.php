...
class Bve_confirm extends CI_Controller {
	...
	public function confirm($report_id=NULL) {
		...
		$config['base_url'] = base_url().'reservation/bve_confirm/confirm';
		...
		$data['list_confirm'] = $this->model_select_bve->reservation_confirm($config['per_page'], $report_id);
	...
	public function details($report_id) {
		...
		$data['button_extend'] = base_url().'reservation/bve_propose_extend/extend';
		$data['button_delete'] = base_url().'reservation/bve_confirm/delete';
		$data['button_print'] = base_url().'reservation/export/pdf_brhv_report';
	...
	public function edit($report_id) {
		...
		if(isset($_POST['submit'])){
			$edit = $this->model_edit_bve->reservation_edit_confirm($_POST, $report_id);
			if ($edit) {
				$this->session->set_flashdata('edit_success', 'Data has been updated successfully');	
			}
		redirect("reservation/bve_confirm/confirm");
		}
