...
class Setting_management extends CI_Controller {
	...
	public function index() {
		...
		$data['button_add'] = base_url().'reservation/setting_management/add';
		$data['button_detail'] = base_url().'reservation/setting_management/details';
		$data['button_edit'] = base_url().'reservation/setting_management/edit';
		$data['button_delete'] = base_url().'reservation/setting_management/delete';
	...
	public function add() {
		...
		if(isset($_POST['submit'])){
			...
			redirect("admin/setting_management");
		}
		$this->load->view('template_view', $data);
	}
