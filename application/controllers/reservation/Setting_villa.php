...
class Setting_villa extends CI_Controller {
	...
	public function index() {
		...
		$data['button_add'] = base_url().'reservation/setting_villa/add';
		$data['button_detail'] = base_url().'reservation/setting_villa/details';
		$data['button_edit'] = base_url().'reservation/setting_villa/edit';
		$data['button_delete'] = base_url().'reservation/setting_villa/delete';
