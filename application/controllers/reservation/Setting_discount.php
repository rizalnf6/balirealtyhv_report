...
class Setting_discount extends CI_Controller {
	...
	public function index() {
		...
		$data['button_add'] = base_url().'reservation/setting_discount/add';
		$data['button_detail'] = base_url().'reservation/setting_discount/details';
		$data['button_edit'] = base_url().'reservation/setting_discount/edit';
		$data['button_delete'] = base_url().'reservation/setting_discount/delete';
