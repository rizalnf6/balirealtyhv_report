...
class Bve_confirm extends CI_Controller {
	...
	public function confirm($report_id=NULL) {
		...
		$config['base_url'] = base_url().'receptionist/bve_confirm/confirm';
	...
	public function details($report_id) {
		...
		$data['button_extend'] = base_url().'receptionist/bve_propose_extend/extend';
		$data['button_delete'] = base_url().'receptionist/bve_confirm/delete';
		$data['button_print'] = base_url().'receptionist/export/pdf_brhv_report';
	...
	public function edit($report_id) {
		...
		redirect("receptionist/bve_confirm/confirm");
		}
