...
class Bvo_enquiry extends CI_Controller {
	...
	public function new_enquiry($report_id=NULL) {
		...
		$config['base_url'] = base_url().'receptionist/bvo_enquiry/new_enquiry';
		...
		$data['button_proccess'] = base_url().'receptionist/bvo_enquiry/process_enquiry';
	...
	public function process_enquiry($report_id) {
		...
		redirect("receptionist/bvo_enquiry/new_enquiry");
	}
	...
	public function enquiry($report_id=NULL) {
		...
		//pengaturan pagination
		$config['base_url'] = base_url().'receptionist/bvo_enquiry/enquiry';
		$config['total_rows'] = $jml->num_rows();
		$config['per_page'] = '100';
		$config['first_page'] = 'Awal';
		$config['last_page'] = 'Akhir';
	...
	public function details($report_id) {
		...
		$data['button_edit'] = base_url().'receptionist/bvo_enquiry/edit';
		$data['button_propose'] = base_url().'receptionist/bvo_propose_extend/propose';
		$data['button_delete'] = base_url().'receptionist/bvo_enquiry/delete';
		$data['button_print'] = base_url().'receptionist/bvo_enquiry/print';
	...
	public function edit($report_id) {
		...
		redirect("receptionist/bvo_enquiry/enquiry");
		}
