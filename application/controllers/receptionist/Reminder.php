...
class Reminder extends CI_Controller {
	...
	public function brhv() {
		...
		$data['button_detail_enquiry'] = base_url().'receptionist/brhv_enquiry/details';
		$data['button_detail_confirm'] = base_url().'receptionist/brhv_confirm/details';
		$data['button_edit_enquiry'] = base_url().'receptionist/brhv_enquiry/edit';
		$data['button_edit_confirm'] = base_url().'receptionist/brhv_confirm/edit';
		$data['button_edit_extend'] = base_url().'receptionist/brhv_propose_extend/edit_extend';
		$data['button_edit_propose'] = base_url().'receptionist/brhv_propose_extend/edit_propose';
	...
	public function bve() {
		...
		$data['button_detail_enquiry'] = base_url().'receptionist/bve_enquiry/details';
		$data['button_detail_confirm'] = base_url().'receptionist/bve_confirm/details';
		$data['button_edit_enquiry'] = base_url().'receptionist/bve_enquiry/edit';
		$data['button_edit_confirm'] = base_url().'receptionist/bve_confirm/edit';
		$data['button_edit_extend'] = base_url().'receptionist/bve_propose_extend/edit_extend';
		$data['button_edit_propose'] = base_url().'receptionist/bve_propose_extend/edit_propose';
	...
	public function bvo() {
		...
		$data['button_detail_enquiry'] = base_url().'receptionist/bvo_enquiry/details';
		$data['button_detail_confirm'] = base_url().'receptionist/bvo_confirm/details';
		$data['button_edit_enquiry'] = base_url().'receptionist/bve_enquiry/edit';
		$data['button_edit_confirm'] = base_url().'receptionist/bvo_confirm/edit';
		$data['button_edit_extend'] = base_url().'receptionist/bvo_propose_extend/edit_extend';
		$data['button_edit_propose'] = base_url().'receptionist/bvo_propose_extend/edit_propose';
