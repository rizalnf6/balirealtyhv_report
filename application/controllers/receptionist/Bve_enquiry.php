...
class Bve_enquiry extends CI_Controller {
	...
	public function new_enquiry($report_id=NULL) {
		...
		$config['base_url'] = base_url().'receptionist/bve_enquiry/new_enquiry';
		...
		$data['button_proccess'] = base_url().'receptionist/bve_enquiry/process_enquiry';
	...
	public function process_enquiry($report_id) {
		...
		redirect("receptionist/bve_enquiry/new_enquiry");
	}
	...
	public function details($report_id) {
		...
		$data['button_edit'] = base_url().'receptionist/bve_enquiry/edit';
		$data['button_propose'] = base_url().'receptionist/bve_propose_extend/propose';
		$data['button_delete'] = base_url().'receptionist/bve_enquiry/delete';
		$data['button_print'] = base_url().'receptionist/bve_enquiry/print';
	...
	public function edit($report_id) {
		...
		redirect("receptionist/bve_enquiry/enquiry");
		}
