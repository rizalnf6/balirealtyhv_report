...
class Dashboard extends CI_Controller {
	...
	public function index() {
		...
		$data['button_gotosee_brhv'] = base_url().'receptionist/brhv_enquiry/new_enquiry';
		$data['button_gotosee_bve'] = base_url().'receptionist/bve_enquiry/new_enquiry';
		$data['button_gotosee_bvo'] = base_url().'receptionist/bvo_enquiry/new_enquiry';
