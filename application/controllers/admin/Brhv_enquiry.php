...
class Brhv_enquiry extends CI_Controller {
	...
	public function new_enquiry($report_id=NULL) {
		...
		$config['base_url'] = base_url().'admin/brhv_enquiry/new_enquiry';
		...
		$data['button_proccess'] = base_url().'admin/brhv_enquiry/process_enquiry';
	...
	public function process_enquiry($report_id) {
		...
		redirect("admin/brhv_enquiry/new_enquiry");
	}
	...
	public function details($report_id) {
		...
		$data['button_propose'] = base_url().'admin/brhv_propose_extend/propose';
		$data['button_delete'] = base_url().'admin/brhv_enquiry/delete';
		$data['button_print'] = base_url().'admin/brhv_enquiry/print';
	...
	public function edit($report_id) {
		...
		redirect("admin/brhv_enquiry/enquiry");
		}
