...
class Filter extends CI_Controller {
	...
	public function enquiry_brhv() {
		...
		$data['export_excel'] = base_url().'admin/export/excel_brhv_enquiry';
		$data['filter'] = base_url().'admin/filter/enquiry_brhv';
		$data['reset'] = base_url().'admin/brhv_enquiry/enquiry';
		$data['button_detail'] = base_url().'admin/brhv_enquiry/details';
		$data['button_edit'] = base_url().'admin/brhv_enquiry/edit';
		$data['button_propose'] = base_url().'admin/brhv_propose_extend/propose';
		$data['button_delete'] = base_url().'admin/brhv_enquiry/delete';
	...
	public function enquiry_bve($report_id=NULL) {
		...
		$data['export_excel'] = base_url().'admin/export/excel_bve_enquiry';
		$data['filter'] = base_url().'admin/filter/enquiry_bve';
		$data['reset'] = base_url().'admin/bve_enquiry/enquiry';
		$data['button_detail'] = base_url().'admin/bve_enquiry/details';
		$data['button_edit'] = base_url().'admin/bve_enquiry/edit';
		$data['button_propose'] = base_url().'admin/bve_enquiry/propose';
		$data['button_delete'] = base_url().'admin/bve_enquiry/delete';
	...
	public function confirm_bve($report_id=NULL) {
		...
		$data['export_excel'] = base_url().'admin/export/excel_bve_confirm';
		$data['filter'] = base_url().'admin/filter/confirm_bve';
		$data['reset'] = base_url().'admin/bve_confirm/confirm';
		$data['button_detail'] = base_url().'admin/bve_confirm/details';
		$data['button_edit'] = base_url().'admin/bve_confirm/edit';
		$data['button_extend'] = base_url().'admin/bve_propose_extend/edit_extend';
		$data['button_propose'] = base_url().'admin/bve_propose_extend/edit_propose';
		$data['button_delete'] = base_url().'admin/bve_confirm/delete';
		$data['button_print'] = base_url().'admin/export/pdf_brhv_report';
	...
	public function confirm_bvo($report_id=NULL) {
		...
		$data['export_excel'] = base_url().'admin/export/excel_bvo_confirm';
		$data['filter'] = base_url().'admin/filter/confirm_bvo';
		$data['reset'] = base_url().'admin/bvo_confirm/confirm';
		$data['button_detail'] = base_url().'admin/bvo_confirm/details';
		$data['button_edit'] = base_url().'admin/bvo_confirm/edit';
		$data['button_extend'] = base_url().'admin/bvo_propose_extend/edit_extend';
		$data['button_propose'] = base_url().'admin/bvo_propose_extend/edit_propose';
		$data['button_delete'] = base_url().'admin/bvo_confirm/delete';
		$data['button_print'] = base_url().'admin/export/pdf_brhv_report';
