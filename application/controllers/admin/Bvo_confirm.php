...
class Bvo_confirm extends CI_Controller {
	...
	public function confirm($report_id=NULL) {
		...
		$config['base_url'] = base_url().'admin/bvo_confirm/confirm';
		...
		$data['list_confirm'] = $this->model_select_bvo->admin_confirm($config['per_page'], $report_id);
	...
	public function details($report_id) {
		...
		$data['button_extend'] = base_url().'admin/bvo_propose_extend/extend';
		$data['button_delete'] = base_url().'admin/bvo_confirm/delete';
		$data['button_print'] = base_url().'admin/export/pdf_brhv_report';
