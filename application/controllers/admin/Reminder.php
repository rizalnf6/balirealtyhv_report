...
class Reminder extends CI_Controller {
	...
	public function brhv() {
		...
		$data['button_detail_enquiry'] = base_url().'admin/brhv_enquiry/details';
		$data['button_detail_confirm'] = base_url().'admin/brhv_confirm/details';
		$data['button_edit_enquiry'] = base_url().'admin/brhv_enquiry/edit';
	...
	public function bve() {
		...
		$data['button_detail_enquiry'] = base_url().'admin/bve_enquiry/details';
		$data['button_detail_confirm'] = base_url().'admin/bve_confirm/details';
		$data['button_edit_enquiry'] = base_url().'admin/bve_enquiry/edit';
		$data['button_edit_confirm'] = base_url().'admin/bve_confirm/edit';
		$data['button_edit_extend'] = base_url().'admin/bve_propose_extend/edit_extend';
		$data['button_edit_propose'] = base_url().'admin/bve_propose_extend/edit_propose';
	...
	public function bvo() {
		...
		$data['button_detail_enquiry'] = base_url().'admin/bvo_enquiry/details';
		$data['button_detail_confirm'] = base_url().'admin/bvo_confirm/details';
		$data['button_edit_enquiry'] = base_url().'admin/bve_enquiry/edit';
		$data['button_edit_confirm'] = base_url().'admin/bvo_confirm/edit';
		$data['button_edit_extend'] = base_url().'admin/bvo_propose_extend/edit_extend';
		$data['button_edit_propose'] = base_url().'admin/bvo_propose_extend/edit_propose';
