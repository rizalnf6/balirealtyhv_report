...
class Setting_management extends CI_Controller {
	...
	public function index() {
		...
		$data['button_add'] = base_url().'admin/setting_management/add';
		$data['button_detail'] = base_url().'admin/setting_management/details';
		$data['button_edit'] = base_url().'admin/setting_management/edit';
		$data['button_delete'] = base_url().'admin/setting_management/delete';
